...
<body class="animsition">
	...
	<section class="bg0 p-t-104 p-b-116">
		...
		<?php
 			...
 			$infop = isset($_POST["infop"])?$_POST["infop"] : "";
 			...
 			if($infop == "") {$erreur .= "Le champ info de paiement est vide. <br>";}
 			...
 			if ($_POST["button"])
 			{
 				if($db_found) {
 					...
 					/*echo "L'utilisateur exist deja ou vous n'avez pas rempli tous les champs. <br>";*/
 				}

 					$result = mysqli_query($db_handle, "SELECT * FROM connexion WHERE Email ='%$email%' ");
					...
					if  ($row > 0) 
					{
						...
						echo "utisateur existe deja. ";
					}
 				
 				else
 				{
 					$sql = "INSERT INTO connexion(nom, prenom, Email, Mdp, infop)
 					VALUES('$nom' , '$prenom' , '$email' , '$mdp' , '$infop')";
