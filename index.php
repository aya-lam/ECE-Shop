...
<!-- NE PAS OUBLIER D'AJOUTER LE HEADER ET LE FOOTER -->
					...
					<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
							...
							if (isset ($_POST["button"])) {
						    	...
						    	if($username && $password) {
								   ...
								   if($username==$user && $password== $pass){
										...
										header('Location: http://localhost:8888/eceshop/admin/administration.php');
									...
									echo "Veuillez remplir les deux champs d'identification !";
								 }
						...
						<form action="" method="POST"> 
							...
							<div class="bor8 m-b-20 how-pos4-parent">
								<input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="username" placeholder=" Pseudonyme">
							</div>
							...
							<input class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" name="button" type="submit" value="Valider" />

							<!--<h3> Pseudonyme </h3> <input type="text" name="username"> <br><br>
							<h3> Mot de passe </h3> <input type="password" name="password"> <br><br><br> <input type="submit" name="submit">-->
